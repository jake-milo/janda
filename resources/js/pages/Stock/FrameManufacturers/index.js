                    ...
                    >
                        {manufacturers.map(manufacturer => (
                            <Row key={manufacturer.id}>
                                ...
                                <Cell>
                                    {manufacturer.time.created.format(
                                        "Do MMMM YYYY @ HH:mm"
                                    )}
                                </Cell>
                                <Cell>
                                    {manufacturer.time.updated.format(
                                        "Do MMMM YYYY @ HH:mm"
                                    )}
                                </Cell>
                                <Cell>
                                    <Link
                                        to={`${match.url}/${manufacturer.id}/edit`}
                                    >
                                        <RoundEdit />
                                    </Link>
                                    <a
                                        href="#remove"
                                        onClick={handleRemove(manufacturer)}
                                    >
                                        <BaselineDelete />
                                    </a>
                                </Cell>
