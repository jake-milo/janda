    ...
    return (
        <>
                        ...
                        {patients.map(patient => (
                            <Row key={patient.id}>
                                ...
                                <Cell>
                                    {patient.practice ? (
                                        <Link
                                            to={`/practices/${patient.practice.id}`}
                                        >
                                ...
                                <Cell>
                                    {patient.time.created.format(
                                        "Do MMMM YYYY @ HH:mm"
                                    )}
                                </Cell>
                                <Cell>
                                    {patient.time.updated.format(
                                        "Do MMMM YYYY @ HH:mm"
                                    )}
                                </Cell>
                                <Cell>
                                    <Link
                                        to={`${match.path}/edit/${patient.id}`}
                                    >
                                        <RoundEdit />
                                    </Link>
            ...
            <Route
                ...
                render={() => <PatientModal onSuccess={handlePatientSaved} />}
            />
